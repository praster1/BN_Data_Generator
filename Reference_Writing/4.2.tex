~~~~Suppose we generate a data based on the model as Figure 4.1. This model is 'Bayesian network model of Asia Data Set by Lauritzen and Spiegelhalter' to be introduced in the next chapter.
